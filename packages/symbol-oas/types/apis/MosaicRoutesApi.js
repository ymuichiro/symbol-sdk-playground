...
class MosaicRoutesApi extends runtime.BaseAPI {
     ...
     * Get mosaic information
     */
    getMosaic(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMosaicRaw(requestParameters, initOverrides);
     ...
     * Get mosaic merkle information
     */
    getMosaicMerkle(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMosaicMerkleRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Get mosaics information for an array of mosaics
     */
    getMosaics(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMosaicsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Search mosaics
     */
    searchMosaicsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
     ...
     * Search mosaics
     */
    searchMosaics(requestParameters = {}, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.searchMosaicsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}

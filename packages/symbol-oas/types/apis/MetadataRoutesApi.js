...
class MetadataRoutesApi extends runtime.BaseAPI {
     ...
     * Get metadata merkle information
     */
    getMetadataMerkle(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMetadataMerkleRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    searchMetadataEntriesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
     ...
     * Search metadata entries
     */
    searchMetadataEntries(requestParameters = {}, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.searchMetadataEntriesRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
